...
public class Metals {
	...
	public static void main(String[] args) throws Exception {
		...
		int[] lengths10 = { 149, 3983, 902, 1953, 7292, 6404, 5028, 9786, 7240, 9071, 6485, 9912, 1834, 2206, 5446,
				5825, 5560, 8766, 8938, 7762, 7381, 9206, 8868, 5467, 179, 7250, 2899, 2000, 3637, 1939, 3237, 846,
				6793, 9621, 9445, 5387, 1158, 1617, 4407, 848, 8771, 7828, 423, 1611, 9032, 9424, 6876, 2304, 6985,
				7937 };

		System.out.println(calculateMaximumProfit(cost_per_cut, metal_price, lengths));
		System.out.println(calculateMaximumProfit2(cost_per_cut, metal_price, lengths));
		System.out.println(calculateMaximumProfit(cost_per_cut3, metal_price3, lengths3));
		System.out.println(calculateMaximumProfit2(cost_per_cut3, metal_price3, lengths3));
		System.out.println(calculateMaximumProfit(cost_per_cut10, metal_price10, lengths10));
		System.out.println(calculateMaximumProfit2(cost_per_cut10, metal_price10, lengths10));
	}
	...
	public static long calculateMaximumProfit2(int costpercut, int price, int[] arr) {
		...
		for (int size = 1; size <= max; size++) {
			...
			for (int i = 0; i < arr.length; i++) {
				...
				int cuts = arr[i] % size == 0 ? (arr[i] / size) - 1 : (arr[i] / size); // Number of cuts depend on the
																						// length of rod.
